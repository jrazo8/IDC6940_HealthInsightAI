...
Encoded as 0 = No, 1 = Yes (except Sex: 0 = Female, 1 = Male):
...
Encoded as numerical ranks to preserve meaningful order:
...
BMI: Numeric variable representing Body Mass Index.
...
A statistical summary of the dataset’s features provides insights into distribution patterns, central tendencies (mean, median), and variance among key health indicators. This analysis helps identify potential imbalances, outliers, and preprocessing needs, such as scaling or encoding, to ensure optimal model performance.
