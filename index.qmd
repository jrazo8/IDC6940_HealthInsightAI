...
Model 3 attempts to show us how using SMOTE to try to balance the target variable affects the model. It uses the same k value as model 2 but uses a "distance" weight instead of a "uniform" weight.
...
Now that the three models have been trained we can focus on evaluating them. Table 5 below shows the summary of the three models. 
